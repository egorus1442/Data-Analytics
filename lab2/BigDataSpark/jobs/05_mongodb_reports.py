...
MONGO_URI = "mongodb://spark:spark@mongodb:27017/?authSource=admin"
MONGO_DB  = "sparkdb"
...
spark = SparkSession.builder.appName("MongoDBReports").getOrCreate()
...
write_mongo(report1, "report_products_sales")
...
write_mongo(report2, "report_customers_sales")
...
write_mongo(report3, "report_time_sales")
...
write_mongo(report4, "report_stores_sales")
...
write_mongo(report5, "report_suppliers_sales")
...
write_mongo(report6, "report_product_quality")
