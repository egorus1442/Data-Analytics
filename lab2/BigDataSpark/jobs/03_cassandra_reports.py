...
write_cassandra(report1, "report_products_sales")
...
write_cassandra(report2, "report_customers_sales")
...
write_cassandra(report3, "report_time_sales")
...
write_cassandra(report4, "report_stores_sales")
...
write_cassandra(report5, "report_suppliers_sales")
...
write_cassandra(report6, "report_product_quality")
